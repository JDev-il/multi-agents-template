# NG Agentic Flow - Client Agent Instructions
#
# ╔══════════════════════════════════════════════════════════════════╗
# ║                        @config BLOCK                            ║
...
# @config UI_LIBRARY    : Angular Material
# @config STATE         : Signals (built-in)
...
Public env var prefixes derive from `Angular` - agent applies correct
